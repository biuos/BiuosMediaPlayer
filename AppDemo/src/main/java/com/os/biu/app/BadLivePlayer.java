...
class BadLivePlayer extends AbstractLivePlayer {
    protected BadLivePlayer(@NonNull Application app, @NonNull Handler handler, @NonNull IListenerActionRun actionRun) {
