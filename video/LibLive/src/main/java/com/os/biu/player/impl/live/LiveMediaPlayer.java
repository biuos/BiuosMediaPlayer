package com.os.biu.player.impl.live;
...
@PlayerImplClass(desc = "LIVE", clazz = LiveMediaPlayer.class)
final class LiveMediaPlayer extends AbstractLivePlayer {
    LiveMediaPlayer(@NonNull Application app,
