package com.os.biu.player.impl.vod;
...
@PlayerImplClass(canWork = true, desc = "VOD", clazz = VodMediaPlayer.class)
final class VodMediaPlayer extends AbstractVodPlayer {
    protected VodMediaPlayer(@NonNull Application app,
